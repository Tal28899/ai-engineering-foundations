    ...
    for attempts in range(max_retries):
        try:
            ...
            if not response or not response.strip():
                ...
                return None
            # Returning response generated by groq api
            return (response)
        ...
        # Handling rate limit error by waiting for the specified time before retrying
        except groq.RateLimitError as e:
            last_error = "Rate limit hit"

            # Getting the retry-after header from the response to determine how long to wait before retrying
